...
abstract final class BotStrings {
  static const Map<String, Map<String, String>> _data = {
    ...
    'welcome': {
      ...
      'kmr':
          'سلاڤ! 👋  ئەز هاریکارێ پشتگیریا تەمە.\n'
    ...
    'error': {
      'en':
          'I\'m having trouble reaching the assistant right now. Please check '
          'your connection and try again, or contact our support team from the '
          'Services section.',
      'ar':
          'أواجه مشكلة في الوصول إلى المساعد الآن. يرجى التحقق من اتصالك '
          'والمحاولة مرة أخرى، أو التواصل مع فريق الدعم من قسم الخدمات.',
      'ckb':
          'ئێستا کێشەم هەیە لە گەیشتن بە یاریدەدەرەکە. تکایە پەیوەندیەکەت بپشکنە '
          'و دووبارە هەوڵبدەوە، یان پەیوەندی بە تیمی پشتگیریمانەوە بکە لە بەشی '
          'خزمەتگوزارییەکان.',
      'kmr':
          'نوکە کێشە هەیە د گەهشتنا هاریکاری دا. ژ کەرەما خۆ پەیوەندیا خۆ '
