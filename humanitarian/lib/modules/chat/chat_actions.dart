...
/// Chat entry points that don't belong to a specific conversation screen.
///
/// The donor↔campaign-owner direct chat flow (formerly `startChat`) was
/// retired along with its backend routes; only the staff/tech support chat
/// remains here.
