                ...
                <div style={{ marginTop: 8 }}>
                  <ChatLifecycleControls
                    ...
                    onChanged={async () => {
                      ...
                      // renders from `selected`, so a stale copy would show
                      // the old state until the next poll.
                ...
                {messages.map((m) => {
                  ...
                  return (
                    <div key={m.id} style={{ alignSelf: align, maxWidth: '72%' }}>
                      <div className="muted" style={{ fontSize: 11, marginBottom: 2, textAlign: isOwner ? 'end' : 'start' }}>
                        {isSupport
                      ...
                      <div className="muted" style={{ fontSize: 10, marginTop: 2, textAlign: isOwner ? 'end' : 'start' }}>
