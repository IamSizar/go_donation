...
// Same label-reuse pattern as the case fields above. Most of this form asks
// the same questions the recipient and volunteer forms do, so most rows point
// at a key one of those families already introduced — only the twelve fields
// unique to matchmaking (skin tone, assets owned, what the applicant is
// looking for in a partner, residence history) needed a new one.
...
export const MARRIAGE_FIELD_LABEL_KEYS: Record<string, string> = {
  ...
  nearest_landmark:         'field.nearest_landmark',
  gps_location:             'field.gps_location',
  years_current_residence:  'field.years_current_residence',
  previous_residence:       'field.previous_residence',
  years_previous_residence: 'field.years_previous_residence',
  housing_type:             'field.housing_type',
  rental_amount:            'field.rental_amount',
  housing_area:             'field.housing_area',
  floors_count:             'field.floors_count',
  ...
  working_hours:            'field.working_hours',
  monthly_income:           'field.monthly_income',
  skin_tone:                'field.skin_tone',
  family_members:           'field.family_members',
  children_count:           'field.children_count',
  smoking_status:           'field.smoking_status',
  eyesight_condition:       'field.eyesight_condition',
  has_disability:           'field.has_disability',
  disability_type:          'field.disability_type',
  ...
  skills:                   'field.skills',
  owns_car:                 'field.owns_car',
  owns_house:               'field.owns_house',
  owns_shop:                'field.owns_shop',
  owns_company:             'field.owns_company',
  owns_land:                'field.owns_land',
  other_assets:             'field.other_assets',
  partner_requirements:     'field.partner_requirements',
  personal_photo:           'field.profile_picture',
  golden_square:            'field.golden_square_photo',
  graduation_cert:          'field.graduation_cert_photo',
  cv:                       'field.cv_photo',
  social_facebook:          'field.social_facebook',
  social_instagram:         'field.social_instagram',
  social_telegram:          'field.social_telegram',
